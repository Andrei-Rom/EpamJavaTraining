...
public class Bus {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 7; i++) {
            switch (i) {
                case 0:
                    System.out.println("The bus left from the park.");
                    PHASER.arrive();//В фазе 0 всего 1 участник - автобус
                    break;
                case 6:
                    System.out.println("The bus arrived at the park.");
    ...
    public static class Passenger extends Thread {
        ...
        public Passenger(int departure, int destination) {
            ...
            System.out.println(this + " is waiting at the bus stop # " + this.departure);
        }
